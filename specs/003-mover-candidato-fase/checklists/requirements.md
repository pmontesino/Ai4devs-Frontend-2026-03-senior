# Lista de Comprobación de Calidad: Mover Candidato Entre Fases
...
- [x] Sin marcadores [NECESITA CLARIFICACIÓN]
...
- [x] Los escenarios de usuario cubren los flujos principales (movimiento exitoso + gestión de error)
